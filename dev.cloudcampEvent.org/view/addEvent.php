...
<?php require_once ('header.php') ?>
	<link rel="stylesheet" href="web/css/layout_marketingcamp.css">
	<link rel="stylesheet" href="web/css/jquery-ui-timepicker-addon.css" />
   <script src="http://code.jquery.com/ui/1.10.3/jquery-ui.js" type="text/javascript"></script>
      ...
      $(function() {
        ...
        $( "#event_sponcership_deadline" ).datetimepicker();
...
<div id="wrapper-ht">
	...
	<div id="content">
    <?php require_once('main_addEventContent.php')?>			
	</div> <!-- end content -->	
	<div class="push"></div>
</div><!-- end wrapper-ht -->
